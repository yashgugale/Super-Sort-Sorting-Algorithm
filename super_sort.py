...
def supersort(L, left, right):
    ...
    intermediate_list_1 = merge(Forward_sorted_list, Backward_sorted_list)  #store merged Forward_sorted_list and Backward_sorted_list in intermediate_list1
    ...
    intermediate_list_2 = merge(Mid_list1, Mid_list2)    		#merge left and right sorted sublist
    ...
    #print("The intermediate merged list from forward and backward sorted list is: ", intermediate_list_1)
    #print("The intermediate merged list from merging left and right sublist is: ", intermediate_list_2)
    return(merge(intermediate_list_1, intermediate_list_2))
